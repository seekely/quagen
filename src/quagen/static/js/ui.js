var ui = (function(exports) {
    ...
    return {
      c: function create() {
        ...
        attr(
          ...
          "class",
          (button_class_value =
            "spot spot-color-" + ctx.color + " svelte-17jgu0o")
        );
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$$.update = (
      $$dirty = { power: 1, maxPower: 1, lastMove: 1, allowMove: 1 }
    ) => {
      if ($$dirty.power || $$dirty.maxPower) {
        $$invalidate(
          "opacity",
          (opacity =
      ...
      if ($$dirty.lastMove) {
        $$invalidate("pendingMove", (pendingMove = lastMove ? false : false));
      }
    ...
    return {
      c: function create() {
        ...
        attr(
          ...
          "class",
          (div_class_value =
            "container bg-color-" + ctx.player + " svelte-1ec8cbf")
        );
  ...
  function instance$3($$self, $$props, $$invalidate) {
    ...
    $$self.$set = $$props => {
      ...
      if ("player" in $$props)
        $$invalidate("player", (player = $$props.player));
  ...
  function create_each_block$1(ctx) {
    ...
    var score_spread_levels = [{ player: ctx.i }, ctx.score];
    ...
    return {
      ...
      p: function update(changed, ctx) {
        var score_changes = changed.scores
  ...
  /* src\quagen\ui\options\App.svelte generated by Svelte v3.9.1 */
  ...
  // (92:8) {#each difficulties as difficulty}
  function create_each_block$2(ctx) {
    ...
    return {
      c: function create() {
        ...
        t0 = text(t0_value);
        t1 = space();
        attr(button, "class", "button-difficulty svelte-1aalmvf");
        attr(
          button,
          "difficulty",
        ...
        add_location(button, file$6, 92, 10, 1662);
  ...
  function create_fragment$6(ctx) {
    ...
    return {
      c: function create() {
        ...
        add_location(img, file$6, 80, 4, 1346);
        attr(div0, "class", "block svelte-1aalmvf");
        add_location(div0, file$6, 79, 2, 1322);
        attr(button0, "class", "button-play button-ai svelte-1aalmvf");
        add_location(button0, file$6, 86, 8, 1470);
        add_location(div1, file$6, 85, 6, 1456);
        attr(div2, "class", "difficulty svelte-1aalmvf");
        add_location(div2, file$6, 90, 6, 1584);
        attr(div3, "class", "option-ai svelte-1aalmvf");
        add_location(div3, file$6, 84, 4, 1426);
        attr(button1, "class", "button-play button-friend svelte-1aalmvf");
        add_location(button1, file$6, 104, 6, 1992);
        attr(div4, "class", "option-friend svelte-1aalmvf");
        add_location(div4, file$6, 103, 4, 1958);
        attr(div5, "class", "block svelte-1aalmvf");
        add_location(div5, file$6, 83, 2, 1402);
        attr(div6, "class", "container svelte-1aalmvf");
        add_location(div6, file$6, 78, 0, 1296);
