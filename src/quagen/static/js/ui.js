var ui = (function(exports) {
  ...
  class GameState {
    ...
    update(state) {
      this.completed =
        "completed" in state ? state["completed"] : this.completed;
      ...
      this.turnCompleted =
        "turn_completed" in state
          ? state["turn_completed"]
          : this.turnCompleted;
      this.timeCompleted =
        "time_completed" in state
          ? state["time_completed"]
          : this.timeCompleted;
      this.timeCreated =
      ...
      // player
      this.moveHistory =
        "history" in state ? state["history"] : this.moveHistory;
    ...
    return {
      c: function create() {
        ...
        set_style(
          button,
          "background-color",
          toRGBA(ctx.buttonColor, ctx.buttonOpacity)
        );
        ...
        toggle_class(
          button,
          "outline",
          ctx.lastMove || ctx.pendingMove || ctx.selected
        );
        toggle_class(
          button,
          "pulse",
          !ctx.pendingMove && !ctx.lastMove && ctx.buttonEnabled
        );
        toggle_class(
          button,
          "selected",
          ctx.selected && !ctx.pendingMove && !ctx.lastMove && ctx.buttonEnabled
        );
      ...
      p: function update(changed, ctx) {
        ...
        if (
          changed.buttonEnabled &&
          button_disabled_value !== (button_disabled_value = !ctx.buttonEnabled)
        ) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<Spot> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$set = $$props => {
      ...
      if ("pressures" in $$props)
        $$invalidate("pressures", (pressures = $$props.pressures));
      if ("power" in $$props) $$invalidate("power", (power = $$props.power));
      if ("maxPower" in $$props)
        $$invalidate("maxPower", (maxPower = $$props.maxPower));
      if ("selected" in $$props)
        $$invalidate("selected", (selected = $$props.selected));
      if ("allowMove" in $$props)
        $$invalidate("allowMove", (allowMove = $$props.allowMove));
      if ("pendingMove" in $$props)
        $$invalidate("pendingMove", (pendingMove = $$props.pendingMove));
      if ("lastMove" in $$props)
        $$invalidate("lastMove", (lastMove = $$props.lastMove));
    };
    ...
    $$self.$$.update = (
      ...
      if ($$dirty.allowMove || $$dirty.power || $$dirty.maxPower) {
        $$invalidate(
          "buttonEnabled",
  ...
  class Spot extends SvelteComponentDev {
    ...
    get x() {
      throw new Error(
        "<Spot>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set x(value) {
      throw new Error(
        "<Spot>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function create_each_block_1(ctx) {
    ...
    var spot_spread_levels = [
      ...
      {
        pendingMove:
          ctx.selectedX == ctx.x && ctx.selectedY == ctx.y && ctx.pendingMove
      }
    ];
        ...
        var spot_changes =
          ...
          changed.pendingMove
            ? get_spread_update(spot_spread_levels, [
                ...
                (changed.selectedX || changed.selectedY) && {
                  selected: ctx.selectedX == ctx.x && ctx.selectedY == ctx.y
                },
                (changed.isLastMove || changed.lastMoves) && {
                  lastMove: isLastMove(ctx.lastMoves, ctx.x, ctx.y)
                },
                (changed.selectedX ||
                  changed.selectedY ||
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    $$self.$set = $$props => {
      if ("turnCompleted" in $$props)
        $$invalidate("turnCompleted", (turnCompleted = $$props.turnCompleted));
      if ("width" in $$props) $$invalidate("width", (width = $$props.width));
      if ("height" in $$props)
        $$invalidate("height", (height = $$props.height));
      if ("spots" in $$props) $$invalidate("spots", (spots = $$props.spots));
      if ("allowMove" in $$props)
        $$invalidate("allowMove", (allowMove = $$props.allowMove));
      if ("moveHistory" in $$props)
        $$invalidate("moveHistory", (moveHistory = $$props.moveHistory));
    };
    ...
    $$self.$$.update = (
      ...
      if ($$dirty.turnCompleted) {
        $$invalidate("selectedX", (selectedX = turnCompleted ? -1 : -1));
      }
      if ($$dirty.turnCompleted) {
        $$invalidate("selectedY", (selectedY = turnCompleted ? -1 : -1));
      }
      if ($$dirty.turnCompleted) {
        $$invalidate(
          "pendingMove",
      ...
      if ($$dirty.width) {
        $$invalidate("containerWidth", (containerWidth = width * 26 + 75));
      }
  ...
  class Board extends SvelteComponentDev {
    constructor(options) {
      ...
      const props = options.props || {};
      if (
        ctx.handleSpotSelected === undefined &&
        !("handleSpotSelected" in props)
      ) {
        console.warn(
          "<Board> was created without expected prop 'handleSpotSelected'"
        );
      }
    ...
    return {
      c: function create() {
        ...
        attr(
          div0,
          "class",
          (div0_class_value = "inner bg-color-" + ctx.color + " svelte-jyd0vx")
        );
      ...
      p: function update(changed, ctx) {
        ...
        if (
          ...
          div0_class_value !==
            (div0_class_value =
              "inner bg-color-" + ctx.color + " svelte-jyd0vx")
        ) {
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<Score> was created with unknown prop '${key}'`);
    });

    $$self.$set = $$props => {
      if ("key" in $$props) $$invalidate("key", (key = $$props.key));
      if ("color" in $$props) $$invalidate("color", (color = $$props.color));
      if ("gameOver" in $$props)
        $$invalidate("gameOver", (gameOver = $$props.gameOver));
      if ("winner" in $$props)
        $$invalidate("winner", (winner = $$props.winner));
      if ("controlled" in $$props)
        $$invalidate("controlled", (controlled = $$props.controlled));
      if ("pressuring" in $$props)
        $$invalidate("pressuring", (pressuring = $$props.pressuring));
      if ("projected" in $$props)
        $$invalidate("projected", (projected = $$props.projected));
    };

    let crown;

    $$self.$$.update = ($$dirty = { gameOver: 1, winner: 1 }) => {
      if ($$dirty.gameOver || $$dirty.winner) {
        $$invalidate("crown", (crown = gameOver && winner));
      }
    };
  ...
  class Score extends SvelteComponentDev {
    ...
    get key() {
      throw new Error(
        "<Score>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set key(value) {
      throw new Error(
        "<Score>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function instance$3($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<Scores> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$set = $$props => {
      if ("gameOver" in $$props)
        $$invalidate("gameOver", (gameOver = $$props.gameOver));
      if ("scores" in $$props)
        $$invalidate("scores", (scores = $$props.scores));
      if ("leaders" in $$props)
        $$invalidate("leaders", (leaders = $$props.leaders));
    };

    let tied;

    $$self.$$.update = ($$dirty = { gameOver: 1, leaders: 1 }) => {
      if ($$dirty.gameOver || $$dirty.leaders) {
        $$invalidate("tied", (tied = gameOver && leaders.length > 0));
      }
    };
  ...
  class Scores extends SvelteComponentDev {
    ...
    get gameOver() {
      throw new Error(
        "<Scores>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set gameOver(value) {
      throw new Error(
        "<Scores>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<StartPrompt> was created with unknown prop '${key}'`);
    });

    $$self.$set = $$props => {
      if ("gameId" in $$props)
        $$invalidate("gameId", (gameId = $$props.gameId));
      if ("vsHumans" in $$props)
        $$invalidate("vsHumans", (vsHumans = $$props.vsHumans));
    };
  ...
  class StartPrompt extends SvelteComponentDev {
    ...
    get gameId() {
      throw new Error(
        "<StartPrompt>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set gameId(value) {
      throw new Error(
        "<StartPrompt>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
    ...
    return {
      ...
      p: function update(changed, ctx) {
        ...
        if (changed.gameState)
          board_changes.height = ctx.gameState.getSetting("dimension_x");
        if (changed.gameState)
          board_changes.width = ctx.gameState.getSetting("dimension_y");
        if (changed.gameState)
          board_changes.moveHistory = ctx.gameState.moveHistory;
        if (changed.allowMove) board_changes.allowMove = ctx.allowMove;
        if (changed.spots) board_changes.spots = ctx.spots;
        if (changed.turnCompleted)
          board_changes.turnCompleted = ctx.turnCompleted;
  ...
  function create_if_block_1$2(ctx) {
    ...
    return {
      ...
      p: function update(changed, ctx) {
        ...
        if (changed.gameState)
          startprompt_changes.gameId = ctx.gameState.gameId;
        if (changed.gameState)
          startprompt_changes.vsHumans = ctx.gameState.isVsHuman();
  ...
  function instance$6($$self, $$props, $$invalidate) {
    ...
    $$self.$$.update = ($$dirty = { gameState: 1, gameOver: 1 }) => {
      if ($$dirty.gameState) {
        $$invalidate("init", (init = gameState.init));
      }
      if ($$dirty.gameState) {
        $$invalidate("gameOver", (gameOver = gameState.completed));
      }
      if ($$dirty.gameState) {
        $$invalidate(
          "turnCompleted",
      ...
      if ($$dirty.gameOver || $$dirty.gameState) {
        $$invalidate(
          "allowMove",
  ...
  function create_each_block$2(ctx) {
    var button,
      t0_value = ctx.difficulty[0] + "",
      t0,
      t1,
      button_difficulty_value,
      dispose;
    ...
    return {
      c: function create() {
        ...
        attr(
          button,
          "difficulty",
          (button_difficulty_value = ctx.difficulty[1])
        );
        toggle_class(
          button,
          "button-difficulty-selected",
          ctx.aiStrength == ctx.difficulty[1]
        );
