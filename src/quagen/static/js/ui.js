var ui = (function (exports) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(button, "class", button_class_value = "spot spot-color-" + ctx.color + " svelte-112hvw7");
    			...
    			add_location(button, file, 61, 0, 1264);
    		...
    		p: function update(changed, ctx) {
    			if ((changed.color) && button_class_value !== (button_class_value = "spot spot-color-" + ctx.color + " svelte-112hvw7")) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let opacity, pendingMove;

    	$$self.$$.update = ($$dirty = { power: 1, maxPower: 1, lastMove: 1 }) => {
    ...
    // (29:4) {#each { length: height } as _, y}
    function create_each_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t = space();
    			br = element("br");
    			add_location(br, file$1, 37, 8, 831);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$1, 27, 0, 503);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$2, 39, 8, 809);
    			add_location(div1, file$2, 42, 8, 863);
    			add_location(div2, file$2, 45, 8, 916);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$2, 29, 12, 610);
    			add_location(div1, file$2, 32, 12, 674);
    			add_location(div2, file$2, 35, 12, 737);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr(div, "class", div_class_value = "container bg-color-" + ctx.player + " svelte-defa9e");
    			add_location(div, file$2, 26, 0, 540);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((changed.player) && div_class_value !== (div_class_value = "container bg-color-" + ctx.player + " svelte-defa9e")) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t1 = space();
    			div2 = element("div");
    			add_location(div0, file$3, 8, 4, 101);
    			add_location(div1, file$3, 7, 0, 90);
    			set_style(div2, "clear", "both");
    			add_location(div2, file$3, 16, 0, 250);
    		},
    ...
    const file$4 = "src\\quagen\\ui\\game\\App.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p, file$4, 56, 2, 1370);
    		},
    ...
    function create_if_block$1(ctx) {
    	var t0, input, t1, current, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			t0 = space();
    			input = element("input");
    			t1 = text(" See projected board\n\n  ");
    			board.$$.fragment.c();
    			attr(input, "type", "checkbox");
    			add_location(input, file$4, 46, 4, 1043);
    			dispose = listen(input, "change", ctx.handleProjected);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h1, file$4, 40, 0, 959);
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, ["gameId"]);
    	}
